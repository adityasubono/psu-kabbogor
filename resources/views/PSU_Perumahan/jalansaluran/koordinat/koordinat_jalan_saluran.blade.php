...
<script type="text/javascript">
    ...
    $.each(titik_koordinat_jalansaluran, function (index, value) {
        mymap.addMarker({
            lat: value.latitude,
            lng: value.longitude,
            label: 'Jalan Saluran' + index,
            title: 'Titik Ke - ' + index,
            infoWindow: {
                content: ' <div id="content">' +
                    '<div id="siteNotice">' +
                    '<h5 id="firstHeading" class="firstHeading"> Titik Ke - ' + index + '</h5>' +
                    '<p> ID Jalan Saluran :' +  value.jalansaluran_id +'</p>' +
                    '<p>' + value.latitude + ',' + value.longitude + '</p>' +
                    '</div>',
                maxWidth: 400
            }
        ...
        mymap.addMarker({
            ...
            infoWindow: {
                content: ' <div id="content">' +
                    '<div id="siteNotice">' +
                    '<h5 id="firstHeading" class="firstHeading"> Titik Ke -' + index + '</h5>' +
                    '<p> ID Taman dan Penhijauan :' + value.taman_id +'</p>' +
                    '<p>' + value.latitude + ',' + value.longitude + '</p>' +
                    '</div>',
                maxWidth: 400
            }
