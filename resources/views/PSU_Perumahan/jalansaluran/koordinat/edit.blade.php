...
@section('title', 'Edit Data Koordinat jalan Saluran Perumahan')
...
<div class="container-fluid" xmlns="http://www.w3.org/1999/html">
    ...
    <form method="post" action="/koordinatjalansalurans/update/{{$koordinatJalanSaluran->id}}"
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-gray-500">
                <div class="row">
                    <div class="col-sm-8">
                        <h6 class="m-0 font-weight-bold text-primary">Data Koordinat Jalan :
                            {{$koordinatJalanSaluran->latlong}}
                        </h6>
                    </div>
                    <div class="col-sm-4">
                        <h6 class="m-0 font-weight-bold text-primary text-right">ID Koordinat:
                            {{$koordinatJalanSaluran->id}} ||
                            ID Jalan Saluran:
                            {{$koordinatJalanSaluran->jalansaluran_id}}
                        </h6>
                    </div>
                </div>
            </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control @error('longitude') is-invalid
                               ...
                               value="{{$koordinatJalanSaluran->longitude}}">
                        @error('longitude')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
