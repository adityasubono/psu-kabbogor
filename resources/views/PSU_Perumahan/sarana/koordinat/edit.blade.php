...
<div class="container-fluid" xmlns="http://www.w3.org/1999/html">
    ...
    <form method="post" action="/koordinatsarana/update/{{$koordinatSarana->id}}" enctype="multipart/form-data">
        @csrf
        @method('patch')
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control @error('longitude') is-invalid
                               ...
                               value="{{$koordinatSarana->longitude}}">
                        @error('longitude')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
