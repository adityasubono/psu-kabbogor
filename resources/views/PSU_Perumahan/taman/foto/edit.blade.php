...
@section('title', 'Edit Data Foto Taman')
...
<div class="container-fluid" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="card-body bg-gray-200">
        <form action="/fototamans/update/{{$fotoTaman->id}}" method="post"
            ...
            <div class="row">
                ...
                <div class="col-sm-4 mt-3">
                    ...
                    <a href="/fototamans/{{$fotoTaman->taman_id}}" class="btn btn-danger
                    btn-icon-split">
