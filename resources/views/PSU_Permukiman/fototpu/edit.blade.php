...
<div class="container-fluid" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="card-body bg-gray-200">
        <form action="/fototpus/update/{{$data_foto->id}}" method="post"
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <input type="hidden" class="form-control" name="permukiman_id"
                           value="{{$data_foto->permukiman_id }}">
                ...
                <div class="col-sm-6 bg-light border mt-3 text-center rounded">
                    ...
                    <img src="../../assets/uploads/permukiman/{{$data_foto->file_foto}}"
