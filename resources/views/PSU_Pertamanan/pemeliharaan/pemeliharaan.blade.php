...
<div class="container-fluid">
    ...
    <div class="card-body bg-gray-200">
        ...
        <form action="/pemeliharaans/store" method="post">
            @csrf
            <div class="row">
                <div class="col-sm-3">

                    <input type="hidden" class="form-control" id="pertamanan_id"
                           name="data_pemeliharaan[0][pertamanan_id]"
                           value="{{$data_pertamanan->id}}">

                    <label for="nama_alat">Nama Alat </label><br>
                    <input type="text" class="form-control @error('data_pemeliharaan.*.nama_alat') is-invalid
                            @enderror" id="nama_alat"
                           name="data_pemeliharaan[0][nama_alat]"
                           placeholder="Masukan Nama Alat"
                           value="{{ old('data_pemeliharaan[0][nama_alat]') }}">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control @error('data_pemeliharaan.*.tipe')
                           is-invalid @enderror"
                           id="merk"
                           name="data_pemeliharaan[0][tipe]"
                           placeholder="Masukan Merk / Tipe"
                           value="{{ old('data_pemeliharaan[0][tipe]') }}">
                ...
                <div class="col-sm-3">
                    ...
                    <select
                        class="custom-select @error('data_pemeliharaan.*.tahun_perolehan')
                        is-invalid @enderror"
                        id="tahun_perolehan" name="data_pemeliharaan[0][tahun_perolehan]">
                        <option value="{{ old('data_pemeliharaan[0][tahun_perolehan]') }}"
                                selected>
                            {{ old ('data_pemeliharaan[0][tahun_perolehan]') }}
                        </option>
                        @php
                        $tahun=getdate();
                        @endphp
                    ...
                    @error('data_pemeliharaan.*.tahun_perolehan')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                    @enderror
                ...
                <div class="col-sm-3">
                    ...
                    <select
                        ...
                        <option value="{{ old('data_pemeliharaan[0][kondisi]') }}" selected>
                            {{ old ('data_pemeliharaan[0][kondisi]') }}
                        </option>
                ...
                <div class="col-sm-12 mt-2">
                    ...
                    <textarea class="form-control @error('data_pemeliharaan.*.keterangan')
                              is-invalid @enderror" id="keterangan"
                              name="data_pemeliharaan[0][keterangan]"
                              rows="3"
                              placeholder="Masukan Deskripsi Keterangan">{{
                        old('data_pemeliharaan[0][keterangan]')
                        }}</textarea>
                    @error('data_pemeliharaan.*.keterangan')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                    @enderror
    ...
    @include('PSU_Pertamanan.pemeliharaan.tabel_pemeliharaan')
