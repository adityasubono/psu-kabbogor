...
<div class="card shadow mb-4">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h6 class="m-0 font-weight-bold text-primary">Data Softscape :
                    <b class="text-dark">{{$softscape->nama_alat}}</b>
                </h6>
            </div>
            <div class="col-sm-6">
    ...
    <div class="card-body bg-gray-200">
        <form action="/softscapes/update/{{$softscape->id}}" method="post">
            @method('PATCH')
            @csrf
            <div class="row">
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    ...
                    <select
                        ...
                        <option value="{{$softscape->tahun_perolehan}}"
                                selected>
                            {{$softscape->tahun_perolehan}}
                        </option>
                        @php
                        $tahun=getdate();
                        @endphp
                ...
                <div class="col-sm-3">
                    ...
                    <select
                        ...
                        <option value="{{$softscape->kondisi}}" selected>
                            {{$softscape->kondisi}}
                        </option>
                ...
                <div class="col-sm-4 mt-2">
                    <a href="/pemeliharaans/{{$softscape->permukiman_id}}"
