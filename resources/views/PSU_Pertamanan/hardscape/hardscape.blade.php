        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <input type="text" class="form-control @error('data_petugas.*.nama_alat') is-invalid
                       ...
                       value="{{ old('data_hardscape.*.nama_alat') }}">
            ...
            <div class="col-sm-3">
                ...
                <select
                    class="custom-select @error('data_hardscape.*.pendidikan') is-invalid
                    @enderror"
                    id="tahun_diperoleh" name="data_hardscape[0]tahun_diperoleh"
                    value="{{ old('data_hardscape.*.tahun_diperoleh') }}">
                ...
                @error('data_hardscape.*.tahun_diperoleh')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
                @enderror
            ...
            <div class="col-sm-3">
                ...
                <select
                    ...
                    value="{{ old('data_hardscape.*.kondisi') }}">
            ...
            <div class="col-sm-12 mt-2">
                ...
                <textarea class="form-control @error('data_hardscape.*.keterangan_petugas') is-invalid
                              @enderror" id="keterangan"
                          name="data_hardscape[0][keterangan_petugas]"
                          rows="3"
                          placeholder="Masukan Deskripsi Keterangan">{{ old('data_petugas.*.keterangan_petugas')
                        }}</textarea>
                @error('data_hardscape.*.keterangan_petugas')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
                @enderror
